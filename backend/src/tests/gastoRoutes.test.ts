...
describe('Rotas de Gastos', () => {
  ...
  describe('POST /gastos', () => {
    it('cria um gasto válido e retorna 201', async () => {
      const resposta = await request(app).post('/gastos').send({
        categoria: 'COMPRAS',
        data: '2026-08-04',
        descricao: 'Mercado',
        valor: 150,
  ...
  describe('GET /gastos', () => {
    it('lista os gastos do mês informado', async () => {
      await request(app).post('/gastos').send({
        categoria: 'COMPRAS',
        data: '2026-08-04',
        descricao: 'Mercado',
        valor: 150,
  ...
  describe('PUT /gastos/:id', () => {
    it('atualiza um gasto existente e retorna 200', async () => {
      const criado = await request(app).post('/gastos').send({
        categoria: 'COMPRAS',
        data: '2026-08-04',
        descricao: 'Mercado',
        valor: 150,
      ...
      const resposta = await request(app).put(`/gastos/${criado.body.id}`).send({
        categoria: 'COMPRAS',
        data: '2026-08-04',
